...
# set wd
setwd('<#placeholder>') #placeholder, it should be folder with this code and ./group_adonis sub-folder
...
# results folder for multivariate adonis, taxa
...
g
ggsave(plot = g,filename = "./group_adonis/plots_adonis/adonis_taxa_pwys_seq_pergroup.png",width = 5,height = 8) 
write.table(inDFssPT,file = "./group_adonis/plots_adonis/adonis_taxa_pwys_seq_pergroup.csv",sep=',',row.names = F)
