#This script opens a tsv file where there are 4 columns. sample ID, Diet code, Baseline answer,  Followup up answer.
#Each row should be a different combination sample-diet_item
# remove all rows with some NAs (missing Baseline or Followup answer) and count how many answers were identical between both timepoints.
