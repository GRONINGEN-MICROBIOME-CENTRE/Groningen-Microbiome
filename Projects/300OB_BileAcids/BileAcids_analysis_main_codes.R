...
###estimate inter-individual variations of bile acid explained by predictors (use micorbiome as an example) by using 5-fold cross validation (CV) 
...
for(p in threshold){
  results=matrix(NA,nrow = ncol(responder),ncol = 8)
