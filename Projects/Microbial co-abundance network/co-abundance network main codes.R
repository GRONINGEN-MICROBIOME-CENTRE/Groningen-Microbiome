...
TE=c(0.5*log((1+cor_lld)/(1-cor_lld)),0.5*log((1+cor_fg)/(1-cor_fg)),0.5*log((1+cor_ob)/(1-cor_ob)),0.5*log((1+cor_ibd)/(1-cor_ibd))) #transfer spearman coefficient to z-score
