...
BA_norm$R7_Conju_vs_Unconj_CDCA=log10((BA_norm$glycoursodeoxycholate+BA_norm$tauroursodeoxycholate) /BA_norm$ursodeoxycholate)
...
BA_CD=subset(ibd_test_phenos,ibd_test_phenos$clinical_Diagnosis=="CD")
CD_p=ibd_test_phenos[, c("clinical_ActiveDisease","clinical_inflammation_ileum","clinical_ResectionIlealAny","clinical_ResectionIlealCecalAny" )]
CD_p$Resection_ileum="no"
CD_p$Resection_ileum[CD_p$clinical_ResectionIlealCecalAny=="yes" | CD_p$clinical_ResectionIlealAny=="yes"]="yes"
CD_p$Infl="A_no"
CD_p$Infl[CD_p$clinical_ActiveDisease=="NotActive" & CD_p$clinical_inflammation_ileum=="no"]="B_Colon_NonInF"
CD_p$Infl[CD_p$clinical_ActiveDisease=="Active" & CD_p$clinical_inflammation_ileum=="no"]="C_Colon_InF"
CD_p$Infl[CD_p$clinical_ActiveDisease=="NotActive" & CD_p$clinical_inflammation_ileum=="yes"]="D_Ileum_NonInF"
CD_p$Infl[CD_p$clinical_ActiveDisease=="Active" & CD_p$clinical_inflammation_ileum=="yes"]="E_Ileum_InF"



BA_CD=BA_CD[,colnames(BA_CD) %in% PBA | colnames(BA_CD) %in% SBA]
BA_CD=merge(CD_p,BA_CD,by="row.names")
