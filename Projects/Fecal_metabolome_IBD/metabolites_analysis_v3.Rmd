...
######################################
##Taxa predicted from MetaPhlAn2 & 3 #
######################################
#Clean names
...
write.table(q_mtb, "~/Documents/Project_Metabolome/1.Input_files/Imputed_metabolites_v3", sep = "\t",quote = F)
...
#write.table(all_uni_prev,"~/Documents/Project_Metabolome/6.Results/Results_prevalence_mtb_042020_v2.txt",sep="\t", quote = F, row.names = T)
...
only_ibd_quant=read.table("~/Documents/Project_Metabolome/1.Input_files/Models_032020/IBD_only_prevalence.txt",sep="\t", header = T, row.names = 1)
only_ibd_quant$ibd_CurrentStomaOrPouch=NULL
only_ibd_quant$host_Sex.1=NULL
only_ibd_quant$med_parasympathicolytic_inhaler=NULL
only_ibd_quant$med_ranitidine=NULL
...
#write.table(ibd_only_results_prevalence,"~/Documents/Project_Metabolome/6.Results/IBD_only_results_prevalence_mtb_042020_v2.txt",sep="\t", quote = F, row.names = T)
...
for ( i in unique (my_results_for_lasso$metabolite)){
  ...
  #Subset features 
  lasso_train_feature = my_feature_lasso2[lasso_train_samples,, drop=F]
  lasso_test_feature = my_feature_lasso2[-lasso_train_samples,, drop=F]
  #Subset phenos
  lasso_train_phenos = my_phenos_lasso2[lasso_train_samples,]
  lasso_test_phenos = my_phenos_lasso2[-lasso_train_samples,]
  #Cross validation
