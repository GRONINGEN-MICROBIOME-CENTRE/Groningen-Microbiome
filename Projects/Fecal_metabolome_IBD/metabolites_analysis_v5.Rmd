...
##SAVING RESULTS##
##################
write.table(all_uni_quant,"~/Documents/Project_Metabolome/6.Results/052020_CLR/Results_quantitative_mtb_052020.txt",sep="\t", quote = F, row.names = T)
...
cor_diet=cor.test(tot[,64:316], method = "spearman")
#
...
write.table(all_uni_prev,"~/Documents/Project_Metabolome/6.Results/072020/Results_prevalence.txt",sep="\t", quote = F, row.names = T)
...
###
###
write.table(ibd_only_res_clean,"~/Documents/Project_Metabolome/6.Results/072020/Results_lm_onlyIBD.txt",sep="\t", quote = F, row.names = T)
...
write.table(ibd_only_results_prevalence,"~/Documents/Project_Metabolome/6.Results/Results_onlyIBD_prev_052020.txt",sep="\t", quote = F, row.names = T)
...
corr_mtb <- findCorrelation(q_mtb, cutoff=0.75)
remove_corr_mtb=colnames(q_mtb)[corr_mtb]
...
#Define what to test
#rf_IBD=mtb_quantitative_ibd
my_CD=rownames(mtb_quantitative_ibd)[mtb_quantitative_ibd$ibd_Diagnosis=="CD" | mtb_quantitative_ibd$ibd_Diagnosis=="A_Control" ]
my_UC=rownames(mtb_quantitative_ibd)[mtb_quantitative_ibd$ibd_Diagnosis=="UC" | mtb_quantitative_ibd$ibd_Diagnosis=="A_Control"]
#rf_IBD=rf_IBD[,c(10,64:ncol(rf_IBD))]
