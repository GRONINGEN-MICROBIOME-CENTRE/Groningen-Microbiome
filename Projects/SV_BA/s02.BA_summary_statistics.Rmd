...
all_basic$Cohort<-as.factor(all_basic$Cohort)
all_basic$Gender<-as.factor(all_basic$Gender)
p_gender<-ggplot(data=all_basic)+
  geom_mosaic(aes(x = product(Cohort), fill=Gender))+
  ylab("Gender")+
  xlab("Cohort")+
