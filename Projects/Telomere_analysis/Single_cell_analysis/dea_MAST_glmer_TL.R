...
################################ Set Variables #################################
# Testing
# opt$in_dir <- 'in_dir_TL'
# opt$cell_level <- 'approach_I'
# opt$cell_level <- 'approach_II'
# opt$cell_type <- 'CD8T_memory'
# opt$cell_type <- 'CD8Tcells'
# opt$covs <- 'covariates.approach_I.tab' 
# opt$covs <- 'covariates.approach_II.tab'
# opt$nagq0 <- FALSE
# opt$genes <- "top3genes"
# opt$out_dir <- 'out_dir.top3genes'
