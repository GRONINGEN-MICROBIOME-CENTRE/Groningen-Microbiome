...
Logistic_model = function(To_test_m){
	...
	rbind(rbind(rbind(rbind(rbind(rbind(Results_PCA_noCov,Results_potein_no_cov),Results_LL_no_cov),Results_HEI_no_cov),Results_aMED_no_cov),Results_Cov_no_cov),Results_PCA_robust_noCov) -> uncorrected_models
	...
	rbind(rbind(rbind(rbind(rbind(Results_PCA,Results_potein),Results_LL),Results_HEI),Results_aMED),Results_PCA_robust) -> Corrected_models
